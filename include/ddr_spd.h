...
typedef struct ddr2_spd_eeprom_s {
	...
	unsigned char t_casemax;    /* 47 t_casemax */
	unsigned char psi_ta_dram;   /* 48 Thermal Resistance of DRAM Package
	...
	unsigned char dt7;         /* 57 DRAM Case Temperature Rise from Ambient
					 ...
					 Auto-Precharge (DT7) */
	unsigned char psi_ta_pll;    /* 58 Thermal Resistance of PLL Package
					from Top (Case) to Ambient
					(Psi T-A PLL) */
	unsigned char psi_ta_reg;    /* 59 Thermal Resistance of Register
